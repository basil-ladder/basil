...
const lastUpdatedTemplate = bots => (0, _litHtml.html)`
        <h2>Recent Bot Updates</h2>

        <div style="max-height: 20em; overflow: auto;">
        <ul style="list-style-type: none; margin: 0; padding: 0;">
        ${bots.map(bot => (0, _litHtml.html)`
            <li class=${_basil.default.racecol(bot.race)}>
            ${bot.lastUpdated} <i class="fas fa-caret-right"></i> <a class="normal " href="bot.html?bot=${bot.botName}">${bot.botName}</a>${bot.won + bot.lost <= 50 ? (0, _litHtml.html)`<span>&#x1F195;</span>` : ""}
            </li>
            `)}
        </ul>
        </div>
...
_axios.default.get(_basil.default.dataBaseUrl + "stats/ranking.json").then(result => {
  ...
  const bots = data.filter(function (x) {
    ...
    bot.lastUpdated = _basil.default.formatDate(bot.lastUpdated);
    return bot;
  });
  (0, _litHtml.render)(lastUpdatedTemplate(bots), document.querySelector("#lastUpdated"));
});
},{"axios":"../node_modules/axios/index.js","./basil.js":"basil.js","lit-html":"../node_modules/lit-html/lit-html.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
