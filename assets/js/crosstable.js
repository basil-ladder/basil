...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"../node_modules/lit-html/lib/directive.js":[function(require,module,exports) {
"use strict";
...
},{"moment":"../node_modules/moment/moment.js"}],"../node_modules/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*!
...
},{"chart.js":"../node_modules/chart.js/dist/Chart.js"}],"../node_modules/flatpickr/dist/flatpickr.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
_chart.default.plugins.unregister(_chartjsPluginDatalabels.default);
...
var _default = {
  ...
  formatDateTime: function (epochSecond) {
    return _moment.default.unix(epochSecond).format("YYYY.MM.DD hh:mm a");
  },
  formatDate: function (epochSecond) {
    return _moment.default.unix(epochSecond).format("YYYY.MM.DD");
  },
...
},{"chart.js":"../node_modules/chart.js/dist/Chart.js","chartjs-plugin-datalabels":"../node_modules/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.js","flatpickr":"../node_modules/flatpickr/dist/flatpickr.js","moment":"../node_modules/moment/moment.js","@fortawesome/fontawesome-free/css/all.css":"../node_modules/@fortawesome/fontawesome-free/css/all.css","flatpickr/dist/flatpickr.css":"../node_modules/flatpickr/dist/flatpickr.css"}],"crosstable.js":[function(require,module,exports) {
"use strict";
...
var _basil = _interopRequireDefault(require("./basil.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function mouseEnter(x, y) {
  if (x >= 0) {
    document.querySelector("tr:first-child th:nth-child(" + (x + 4) + ")").classList.add("highlight");
  }

  document.querySelector("tbody tr:nth-child(" + (y + 1) + ")").classList.add("highlight");
  document.querySelector("tbody tr:nth-child(" + (y + 1) + ") th:nth-child(2)").classList.add("highlight");
}

function mouseLeave(x, y) {
  if (x >= 0) {
    document.querySelector("tr:first-child th:nth-child(" + (x + 4) + ")").classList.remove("highlight");
  }

  document.querySelector("tbody tr:nth-child(" + (y + 1) + ")").classList.remove("highlight");
  document.querySelector("tbody tr:nth-child(" + (y + 1) + ") th:nth-child(2)").classList.remove("highlight");
}

const crossTable = bots => (0, _litHtml.html)`
...
<tr>
    ...
    ${bots.map(bot => (0, _litHtml.html)`<th class="rot30 ${_basil.default.racecol(bot.race)}"><div>${bot.name}</div></th>`)}
</tr>
</thead>
<tbody>
${bots.map((bot, index) => (0, _litHtml.html)`
<tr>
    <th>${index + 1}</th>
    <th @mouseenter=${e => mouseEnter(-2, index)} @mouseleave=${e => mouseLeave(-2, index)} class=${_basil.default.racecol(bot.race)}>${bot.name}</th>
    <th @mouseenter=${e => mouseEnter(-1, index)} @mouseleave=${e => mouseLeave(-1, index)}>${bot.rating}</th>
    ${bot.row.map((col, i) => (0, _litHtml.html)`
        <td style="background-color: rgba(${col.color});" @mouseenter=${e => mouseEnter(i, index)} @mouseleave=${e => mouseLeave(i, index)}>
        ${col.self ? "" : (0, _litHtml.html)`<span>${col.won} - ${col.lost}</span>`}
        </td>
    `)}
</tr>`)}
</tbody>
...
<label for="minElo" style="margin-left: 0.8em;">Min ELO</label><input style="width: 5em;" type="number" id="minElo" value=${refs.minElo} min="0" max="5000" @change=${e => {
  refs.minElo = e.target.value;
  update();
}}>	
<label for="maxElo" style="margin-left: 0.8em;">Max ELO</label><input style="width: 5em;" type="number" id="maxElo" value=${refs.maxElo} min="0" max="5000" @change=${e => {
  refs.maxElo = e.target.value;
  update();
}}>	
<label for="range" style="margin-left: 0.8em;">Range</label>
<select id="range" ref="range" @change=${e => {
  refs.range = e.target.value;
  update();
}}>
    ${ranges.map(days => (0, _litHtml.html)`
...
(0, _litHtml.render)(form, formNode);

function update() {
  let suffix = refs.range;
  if (!suffix) suffix = "";else suffix = "_" + suffix;

  _axios.default.get(_basil.default.dataBaseUrl + "stats/botVsBot" + suffix + ".json").then(result => {
    const recv = result.data;
    let stats = {};

    function entry(a, b) {
      if (!stats[a]) stats[a] = {};
      if (!stats[a][b]) stats[a][b] = {
        won: 0,
        lost: 0
      };
      return stats[a][b];
    ...
    let relevantBots = bots.filter(function (bot) {
      return (!refs.showEnabledOnly || bot.enabled) && (!bot.rating || bot.rating >= refs.minElo) && (!bot.rating || bot.rating <= refs.maxElo);
    });
    ...
    (0, _litHtml.render)(crossTable(bots), crossTableNode);
  });
}
...
*/
},{"axios":"../node_modules/axios/index.js","lit-html":"../node_modules/lit-html/lit-html.js","./basil.js":"basil.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","crosstable.js"], null)
//# sourceMappingURL=/assets/js/crosstable.js.map