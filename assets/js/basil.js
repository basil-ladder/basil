...
})({"2RLOf":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "372fd13786fe8b99";
var HMR_USE_SSE = false;
module.bundle.HMR_BUNDLE_ID = "768b0b0db824d45d";
"use strict";
...
},{}],"agUpL":[function(require,module,exports) {
...
var _flatpickrCss = require("flatpickr/dist/flatpickr.css");
(0, _chartJsDefault.default).plugins.unregister((0, _chartjsPluginDatalabelsDefault.default));
...
window.basilUpdateChartsTheme = function() {
    window._basilChartUpdaters.forEach(function(fn) {
        fn();
    });
};
exports.default = {
    ...
    formatDateTime: function(epochSecond) {
        return (0, _momentDefault.default).unix(epochSecond).format("YYYY.MM.DD hh:mm a");
    },
    formatDate: function(epochSecond) {
        return (0, _momentDefault.default).unix(epochSecond).format("YYYY.MM.DD");
    },
...
},{"chart.js":"9ealU","chartjs-plugin-datalabels":"h9wbC","flatpickr":"9TUBE","moment":"jmLGx","@fortawesome/fontawesome-free/css/all.css":"4m4gE","flatpickr/dist/flatpickr.css":"hIdEt","@parcel/transformer-js/src/esmodule-helpers.js":"fzHz3"}],"9ealU":[function(require,module,exports) {
/*!
 * Chart.js v2.9.4
 ...
 */ (function(global, factory) {
    module.exports = factory(function() {
        try {
            return require("dcf84c2b8d413eca");
        } catch (e) {}
    }());
    ...
    var conversions = createCommonjsModule(function(module1) {
        /* MIT license */ // NOTE: conversions should only return primitive values (i.e. arrays, or
        //       values that give correct `typeof` results).
        //       do not use box values types (i.e. Number(), String(), etc.)
        var reverseKeywords = {};
        for(var key in colorName)if (colorName.hasOwnProperty(key)) reverseKeywords[colorName[key]] = key;
        var convert = module1.exports = {
            rgb: {
                channels: 3,
                labels: "rgb"
            },
...
*/ function buildGraph() {
    ...
    function getRgba(string) {
        ...
        var rgb = [
            ...
            0,
            0
        ], a = 1, match = string.match(abbr), hexAlpha = "";
        if (match) {
            match = match[1];
            hexAlpha = match[3];
    ...
    function rgbaString(rgba, alpha) {
        if (alpha === undefined) alpha = rgba[3] !== undefined ? rgba[3] : 1;
    ...
    function hslaString(hsla, alpha) {
        if (alpha === undefined) alpha = hsla[3] !== undefined ? hsla[3] : 1;
        return "hsla(" + hsla[0] + ", " + hsla[1] + "%, " + hsla[2] + "%, " + alpha + ")";
    }
    // hwb is a bit different than rgb(a) & hsl(a) since there is no alpha specific syntax
    // (hwb have alpha optional & 1 is default value)
    function hwbString(hwb, alpha) {
        if (alpha === undefined) alpha = hwb[3] !== undefined ? hwb[3] : 1;
    ...
    /* MIT license */ var Color = function(obj) {
        ...
        if (typeof obj === "string") {
            ...
            else if (vals = colorString.getHsla(obj)) this.setValues("hsl", vals);
            else if (vals = colorString.getHwb(obj)) this.setValues("hwb", vals);
	 ...
	 */ mix: function(mixinColor, weight) {
        ...
        clone: function() {
            ...
            for(var prop in source)if (source.hasOwnProperty(prop)) {
                ...
                if (type === "[object Array]") target[prop] = value.slice(0);
                else if (type === "[object Number]") target[prop] = value;
                else console.error("unexpected color value:", value);
            }
            return result;
        }
    };
    ...
    Color.prototype.setChannel = function(space, index, val) {
        ...
        if (val === undefined) // color.red()
        return svalues[index];
        else if (val === svalues[index]) // color.red(color.red())
        return this;
        // color.red(100)
        svalues[index] = val;
 ...
 */ var helpers = {
	 ...
	 */ arrayEquals: function(a0, a1) {
            ...
            for(i = 0, ilen = a0.length; i < ilen; ++i){
                ...
                } else if (v0 !== v1) // NOTE: two different object instances will never be equal: {x:20} != {x:20}
                return false;
            }
            return true;
        },
	 ...
	 */ _merger: function(key, target, source, options) {
            if (!isValidKey(key)) // We want to ensure we do not copy prototypes over
            // as this can pollute global namespaces
            return;
            var tval = target[key];
            var sval = source[key];
            if (helpers.isObject(tval) && helpers.isObject(sval)) helpers.merge(tval, sval, options);
            else target[key] = helpers.clone(sval);
        },
        /**
	 ...
	 */ _mergerIf: function(key, target, source) {
            ...
            var tval = target[key];
            var sval = source[key];
            if (helpers.isObject(tval) && helpers.isObject(sval)) helpers.mergeIf(tval, sval);
            else if (!target.hasOwnProperty(key)) target[key] = helpers.clone(sval);
        },
        /**
	 ...
	 */ _isPointInArea: function(point, area) {
        ...
        lineTo: function(ctx, previous, target, flip) {
            ...
            if (stepped) {
                ...
                } else if (stepped === "after" && !flip || stepped !== "after" && flip) ctx.lineTo(previous.x, target.y);
 ...
 */ Object.defineProperty(exports$3.prototype, "chartInstance", {
	 ...
	 */ addAnimation: function(chart, animation, duration, lazy) {
        ...
        requestAnimationFrame: function() {
            var me = this;
            if (me.request === null) // Skip animation frame requests until the active one is executed.
            ...
            Object.defineProperty(array, key, {
                ...
                value: function() {
                    ...
                    helpers$1.each(array._chartjs.listeners, function(object) {
                        if (typeof object[method] === "function") object[method].apply(object, args);
                    });
                    return res;
                }
            });
 ...
 */ function unlistenArrayEvents(array, listener) {
	 ...
	 */ _dataElementOptions: [
        ...
        linkScales: function() {
            ...
            if (meta.xAxisID === null || !(meta.xAxisID in scales) || dataset.xAxisID) meta.xAxisID = dataset.xAxisID || scalesOpts.xAxes[0].id;
            if (meta.yAxisID === null || !(meta.yAxisID in scales) || dataset.yAxisID) meta.yAxisID = dataset.yAxisID || scalesOpts.yAxes[0].id;
        },
        getDataset: function() {
	 ...
	 */ destroy: function() {
        ...
        buildOrUpdateElements: function() {
            ...
            if (me._data !== data) {
                if (me._data) // This case happens when the user replaced the data array instance.
	 ...
	 */ _configure: function() {
            ...
            me._config = helpers$1.merge(Object.create(null), [
                ...
                merger: function(key, target, source) {
                    if (key !== "_meta" && key !== "data") helpers$1._merger(key, target, source);
                }
            });
        },
	 ...
	 */ getStyle: function(index) {
            ...
            var style;
            me._configure();
            if (dataset && index === undefined) style = me._resolveDatasetElementOptions(dataset || {});
            else {
                index = index || 0;
	 ...
	 */ resyncElements: function() {
            ...
            if (numData < numMeta) meta.data.splice(numData, numMeta - numData);
            else if (numData > numMeta) me.insertElements(numMeta, numData - numMeta);
        },
        /**
	 * @private
    ...
    var element_line = core_element.extend({
        ...
        draw: function() {
            ...
            for(index = 1; index < points.length; ++index){
                ...
                if (!currentVM.skip) {
                    if (lastDrawnIndex !== index - 1 && !spanGaps || lastDrawnIndex === -1) // There was a gap and this is the first point after the gap
                    ctx.moveTo(currentVM.x, currentVM.y);
                    else // Line to next point
 ...
 */ function computeFlexCategoryTraits(index, ruler, options) {
        ...
        var start, size;
        if (prev === null) // first data: its size is double based on the next point or,
        // if it's also the last data, we use the scale size.
        prev = curr - (next === null ? ruler.end - ruler.start : next - curr);
        if (next === null) // last data: its size is also double based on the previous point.
        next = curr + curr - prev;
	 ...
	 */ calculateBarValuePixels: function(datasetIndex, index, options) {
            ...
            if (stacked || stacked === undefined && stack !== undefined) for(i = 0; i < ilen; ++i){
                imeta = metasets[i];
            ...
            if (minBarLength !== undefined && Math.abs(size) < minBarLength) {
                size = minBarLength;
                if (length >= 0 && !isHorizontal || length < 0 && isHorizontal) head = base - minBarLength;
                else head = base + minBarLength;
            }
            return {
                size: size,
                base: base,
	 ...
	 */ _dataElementOptions: [
        ...
        updateElement: function(arc, index, reset) {
            ...
            if (!reset || !animationOpts.animateRotate) {
                if (index === 0) model.startAngle = opts.rotation;
                else model.startAngle = me.getMeta().data[index - 1]._model.endAngle;
	 ...
	 */ _dataElementOptions: {
        ...
        update: function(reset) {
            ...
            if (showLine) {
                ...
                if (config.tension !== undefined && config.lineTension === undefined) config.lineTension = config.tension;
                // Utility
	 ...
	 */ _resolveDatasetElementOptions: function(element) {
            ...
            if (yScale.options.stacked) {
                ...
                for(i = 0; i < ilen; ++i){
                    ...
                    if (dsMeta.type === "line" && dsMeta.yAxisID === yScale.id) {
                        ...
                        if (stackedRightValue < 0) sumNeg += stackedRightValue || 0;
                        else sumPos += stackedRightValue || 0;
                    }
                }
        ...
        updateBezierControlPoints: function() {
            ...
            if (lineModel.cubicInterpolationMode === "monotone") helpers$1.splineCurveMonotone(points);
            else for(i = 0, ilen = points.length; i < ilen; ++i){
 ...
 */ var core_interaction = {
    ...
    function updateDims(chartArea, params, layout) {
        ...
        if (layout.size) // this layout was already counted for, lets first reduce old size
    ...
    function fitBoxes(boxes, chartArea, params) {
        ...
        for(i = 0, ilen = boxes.length; i < ilen; ++i){
            ...
            if (updateDims(chartArea, params, layout)) {
                changed = true;
                if (refitBoxes.length) // Dimensions changed and there were non full width boxes before this
 ...
 */ var platform_basic = {
        acquireContext: function(item) {
            if (item && item.canvas) // Support for any object associated to a canvas (including a context2d)
            item = item.canvas;
 ...
 */ function initCanvas(canvas, config) {
        ...
        if (renderHeight === null || renderHeight === "") {
            if (canvas.style.height === "") // If no explicit render height and style height, let's apply the aspect ratio,
            // which one can be specified by the user but also by charts as default option
            // (i.e. options.aspectRatio). If not specified, use canvas aspect ratio of 2.
            canvas.height = canvas.width / (config.options.aspectRatio || 2);
            else {
                var displayHeight = readUsedSize(canvas, "height");
                if (displayWidth !== undefined) canvas.height = displayHeight;
            }
        }
        return canvas;
    }
    ...
    function addResizeListener(node, listener, chart) {
        ...
        var resizer = expando.resizer = createResizer(throttled(function() {
            if (expando.resizer) {
                ...
                if (container && container.clientWidth < w && chart.canvas) // If the container size shrank during chart resize, let's assume
 ...
 */ function injectCSS(rootNode, css) {
	 ...
	 */ _ensureLoaded: function(canvas) {
        ...
        acquireContext: function(item, config) {
            ...
            else if (item.length) // Support for array based queries (such as jQuery)
            item = item[0];
            if (item && item.canvas) // Support for any object associated to a canvas (including a context2d)
            item = item.canvas;
        ...
        releaseContext: function(context) {
            ...
            [
                ...
                if (helpers$1.isNullOrUndef(value)) canvas.removeAttribute(prop);
 ...
 */ var core_plugins = {
            ...
            callbacks: {
                ...
                title: function(tooltipItems, data) {
                    ...
                    if (tooltipItems.length > 0) {
                        ...
                        else if (item.xLabel) title = item.xLabel;
                        else if (labelCount > 0 && item.index < labelCount) title = labels[item.index];
                    }
                    return title;
                },
                ...
                label: function(tooltipItem, data) {
                    ...
                    if (label) label += ": ";
                    if (!helpers$1.isNullOrUndef(tooltipItem.value)) label += tooltipItem.value;
    ...
    function pushOrConcat(base, toPush) {
        if (toPush) {
            if (helpers$1.isArray(toPush)) // base = base.concat(toPush);
 ...
 */ function determineAlignment(tooltip, size) {
        ...
        var xAlign = "center";
        var yAlign = "center";
        if (model.y < size.height) yAlign = "top";
        else if (model.y > chart.height - size.height) yAlign = "bottom";
            ...
            merger: function(key, target, source, options) {
                if (key === "xAxes" || key === "yAxes") {
                    ...
                    for(i = 0; i < slen; ++i){
                        ...
                        if (!target[key][i].type || scale.type && scale.type !== target[key][i].type) // new/untyped scale or type changed: let's apply the new defaults
                        // then merge source scale to correctly overwrite the defaults.
                        helpers$1.merge(target[key][i], [
                            core_scaleService.getScaleDefaults(type),
                            scale
                        ]);
                        else // scales type are the same
 ...
 */ function mergeConfig() {
        return helpers$1.merge(Object.create(null), [].slice.call(arguments), {
            merger: function(key, target, source, options) {
                ...
                var sval = source[key];
                if (key === "scales") // scale config merging is complex. Add our own function here for that
                target[key] = mergeScaleConfig(tval, sval);
                else if (key === "scale") // used in polar area & radar charts since there is only one scale
	 ...
	 */ initialize: function() {
            ...
            me.bindEvents();
            if (me.options.responsive) // Initial resize before chart draws (must be silent to preserve initial animations).
            me.resize(true);
            me.initToolTip();
	...
	*/ reset: function() {
        ...
        update: function(config) {
            var me = this;
            var i, ilen;
            if (!config || typeof config !== "object") // backwards compatibility
            config = {
                duration: config,
                lazy: arguments[1]
            };
	 ...
	 */ updateDataset: function(index) {
        ...
        render: function(config) {
            ...
            var onComplete = function(animation) {
                ...
                helpers$1.callback(animationOptions && animationOptions.onComplete, [
                    animation
                ], me);
            };
        ...
        draw: function(easingValue) {
            ...
            if (core_plugins.notify(me, "beforeDraw", [
                easingValue
            ]) === false) return;
	 ...
	 */ drawDataset: function(meta, easingValue) {
            ...
            if (core_plugins.notify(me, "beforeDatasetDraw", [
                args
            ]) === false) return;
	 ...
	 */ _drawTooltip: function(easingValue) {
            ...
            if (core_plugins.notify(me, "beforeTooltipDraw", [
                args
            ]) === false) return;
            tooltip.draw();
	 ...
	 */ unbindEvents: function() {
        ...
        updateHoverStyle: function(elements, mode, enabled) {
            ...
            if (mode === "dataset") this.getDatasetMeta(elements[0]._datasetIndex).controller["_" + prefix + "DatasetHoverStyle"]();
        },
        /**
	 * @private
	 */ eventHandler: function(e) {
            var me = this;
            var tooltip = me.tooltip;
            if (core_plugins.notify(me, "beforeEvent", [
                e
            ]) === false) return;
            ...
            if (bufferedRequest) // If we have an update that was triggered, we need to do a normal render
	 ...
	 */ handleEvent: function(e) {
            ...
            if (e.type === "mouseout") me.active = [];
            else me.active = me.getElementsAtEventForMode(e, hoverOptions.mode, hoverOptions);
            // Invoke onHover hook
            ...
            if (e.type === "mouseup" || e.type === "click") {
                if (options.onClick) // Use e.native here for backwards compatibility
 ...
 */ helpers$1.scaleMerge = mergeScaleConfig;
	 ...
	 */ helpers$1._alignPixel = function(chart, pixel, width) {
        ...
        helpers$1.niceNum = function(range, round) {
            ...
            } else if (fraction <= 1.0) niceFraction = 1;
	 ...
	 */ helpers$1._getParentNode = function(domNode) {
        ...
        helpers$1.longestText = function(ctx, font, arrayOfThings, cache) {
            ...
            for(i = 0; i < ilen; i++){
                ...
                if (thing !== undefined && thing !== null && helpers$1.isArray(thing) !== true) longest = helpers$1.measureText(ctx, data, gc, longest, thing);
                else if (helpers$1.isArray(thing)) // if it is an array lets measure each element
                // to do maybe simplify this function a bit so we can do this more recursively?
                for(j = 0, jlen = thing.length; j < jlen; j++){
                    nestedThing = thing[j];
                    // Undefined strings and arrays should not be measured
                    if (nestedThing !== undefined && nestedThing !== null && !helpers$1.isArray(nestedThing)) longest = helpers$1.measureText(ctx, data, gc, longest, nestedThing);
                }
            }
	 ...
	 */ helpers$1.numberOfLabelLines = function(arrayOfThings) {
            ...
            helpers$1.each(arrayOfThings, function(thing) {
                if (helpers$1.isArray(thing)) {
                    if (thing.length > numberOfLines) numberOfLines = thing.length;
                }
            });
        ...
        helpers$1.color = !chartjsColor ? function(value) {
            ...
            /* global CanvasGradient */ if (value instanceof CanvasGradient) value = core_defaults.global.defaultColor;
            return chartjsColor(value);
        };
        helpers$1.getHoverColor = function(colorValue) {
            /* global CanvasPattern */ return colorValue instanceof CanvasPattern || colorValue instanceof CanvasGradient ? colorValue : helpers$1.color(colorValue).saturate(0.5).darken(0.1).rgbString();
        };
    };
    function abstract() {
 ...
 */ var core_ticks = {
	 ...
	 */ formatters: {
		 ...
		 */ linear: function(tickValue, index, ticks) {
                ...
                if (Math.abs(delta) > 1) {
                    if (tickValue !== Math.floor(tickValue)) // not an integer
                ...
                } else tickString = "0"; // never show decimal places for 0
                return tickString;
            },
            logarithmic: function(tickValue, index, ticks) {
                var remain = tickValue / Math.pow(10, Math.floor(helpers$1.log10(tickValue)));
                if (tickValue === 0) return "0";
                else if (remain === 1 || remain === 2 || remain === 5 || index === 0 || index === ticks.length - 1) return tickValue.toExponential();
                return "";
            }
        }
    };
    ...
    /** Returns a new array containing numItems from arr */ function sample(arr, numItems) {
        var result = [];
 ...
 */ function computeLabelSizes(ctx, tickFonts, ticks, caches) {
        ...
        for(i = 0; i < length; ++i){
            ...
            if (!isNullOrUndef(label) && !isArray(label)) {
                ...
                height = lineHeight;
            } else if (isArray(label)) // if it is an array let's measure each element
    ...
    function nonSkipped(ticksToFilter) {
        ...
        for(index = 0, len = ticksToFilter.length; index < len; ++index){
            ...
            if (typeof item._index !== "undefined") filtered.push(item);
        }
        return filtered;
    }
	...
	*/ _getLabels: function() {
	 ...
	 */ update: function(maxWidth, maxHeight, margins) {
            ...
            if (samplingEnabled) // Generate labels using all non-skipped ticks
	 ...
	 */ _configure: function() {
        ...
        afterBuildTicks: function(ticks) {
            ...
            if (isArray(ticks) && ticks.length) return helpers$1.callback(me.options.afterBuildTicks, [
                me,
                ticks
            ]);
        ...
        fit: function() {
            ...
            else if (display) minSize.width = getTickMarkLength(gridLineOpts) + getScaleLabelHeight(scaleLabelOpts);
            // height
            if (!isHorizontal) minSize.height = me.maxHeight; // fill all the height
            else if (display) minSize.height = getTickMarkLength(gridLineOpts) + getScaleLabelHeight(scaleLabelOpts);
	...
	*/ _getScaleLabel: function(rawValue) {
            ...
            if (v.start !== undefined) return "[" + v.start + ", " + v.end + "]";
	 ...
	 */ _layers: function() {
            ...
            if (!me._isVisible() || tz === gz || me.draw !== me._draw) // backward compatibility: draw has been overridden by custom scale
            return [
                {
                    z: tz,
                    draw: function() {
    ...
    var scale_category = core_scale.extend({
        ...
        _configure: function() {
            ...
            if (!me.isHorizontal()) // For backward compatibility, vertical category scale reverse is inverted.
 ...
 */ function generateTicks(generationOptions, dataRange) {
        ...
        if (spacing < MIN_SPACING && isNullOrUndef$2(min) && isNullOrUndef$2(max)) return [
            rmin,
            rmax
        ];
        numSpaces = Math.ceil(rmax / spacing) - Math.floor(rmin / spacing);
        if (numSpaces > maxNumSpaces) // If the calculated num of spaces exceeds maxNumSpaces, recalculate it
        spacing = helpers$1.niceNum(numSpaces * spacing / maxNumSpaces / unit) * unit;
        if (stepSize || isNullOrUndef$2(precision)) // If a precision is not specified, calculate factor based on spacing
        ...
        if (stepSize) {
            ...
            if (!isNullOrUndef$2(min) && helpers$1.almostWhole(min / spacing, spacing / 1000)) niceMin = min;
            if (!isNullOrUndef$2(max) && helpers$1.almostWhole(max / spacing, spacing / 1000)) niceMax = max;
        }
        numSpaces = (niceMax - niceMin) / spacing;
        // If very close to our rounded value, use it.
        if (helpers$1.almostEquals(numSpaces, Math.round(numSpaces), spacing / 1000)) numSpaces = Math.round(numSpaces);
    ...
    var scale_linearbase = core_scale.extend({
        ...
        handleTickRangeOptions: function() {
            ...
            if (tickOpts.beginAtZero) {
                ...
                if (minSign < 0 && maxSign < 0) // move the top up to 0
                me.max = 0;
                else if (minSign > 0 && maxSign > 0) // move the bottom down to 0
                me.min = 0;
            }
            var setMin = tickOpts.min !== undefined || tickOpts.suggestedMin !== undefined;
            var setMax = tickOpts.max !== undefined || tickOpts.suggestedMax !== undefined;
            if (tickOpts.min !== undefined) me.min = tickOpts.min;
            else if (tickOpts.suggestedMin !== undefined) {
                if (me.min === null) me.min = tickOpts.suggestedMin;
                else me.min = Math.min(me.min, tickOpts.suggestedMin);
            }
            if (tickOpts.max !== undefined) me.max = tickOpts.max;
            else if (tickOpts.suggestedMax !== undefined) {
                if (me.max === null) me.max = tickOpts.suggestedMax;
                else me.max = Math.max(me.max, tickOpts.suggestedMax);
            }
            if (setMin !== setMax) // We set the min or the max but not both.
            // So ensure that our range is good
            // Inverted or 0 length range can happen when
            // ticks.min is set, and no datasets are visible
            {
                if (me.min >= me.max) {
                    if (setMin) me.max = me.min + 1;
                    else me.min = me.max - 1;
                }
            }
            if (me.min === me.max) {
                me.max++;
        ...
        getTickLimit: function() {
            ...
            var maxTicks;
            if (stepSize) maxTicks = Math.ceil(me.max / stepSize) - Math.floor(me.min / stepSize) + 1;
            else {
    ...
    function stackData(scale, stacks, meta, data) {
        ...
        for(i = 0; i < ilen; ++i){
            ...
            pos[i] = pos[i] || 0;
            neg[i] = neg[i] || 0;
            if (opts.relativePoints) pos[i] = 100;
            else if (value.min < 0 || value.max < 0) neg[i] += value.min;
            else pos[i] += value.max;
        }
    }
    ...
    var scale_linear = scale_linearbase.extend({
        determineDataLimits: function() {
            ...
            if (hasStacks === undefined) for(i = 0; !hasStacks && i < ilen; ++i){
                meta = metasets[i];
            ...
            for(i = 0; i < ilen; ++i){
                ...
                if (hasStacks) stackData(me, stacks, meta, data);
                else updateMinMax(me, meta, data);
            }
        ...
        handleDirectionalChanges: function() {
            if (!this.isHorizontal()) // We are in a vertical orientation. The top value is the highest. So reverse the array
            this.ticks.reverse();
        },
        getLabelForIndex: function(index, datasetIndex) {
 ...
 */ function generateTicks$1(generationOptions, dataRange) {
    ...
    var scale_logarithmic = core_scale.extend({
        determineDataLimits: function() {
            ...
            var hasStacks = opts.stacked;
            if (hasStacks === undefined) for(datasetIndex = 0; datasetIndex < datasets.length; datasetIndex++){
            ...
            if (opts.stacked || hasStacks) {
                ...
                if (chart.isDatasetVisible(datasetIndex) && IDMatches(meta)) {
                    ...
                    for(i = 0, ilen = data.length; i < ilen; i++){
                        ...
                        if (value.min !== 0) me.minNotZero = Math.min(value.min, me.minNotZero);
                    }
                }
            }
        ...
        handleTickRangeOptions: function() {
            ...
            if (me.minNotZero === null) {
                if (me.min > 0) me.minNotZero = me.min;
                else if (me.max < 1) me.minNotZero = Math.pow(10, Math.floor(log10(me.max)));
                else me.minNotZero = DEFAULT_MIN;
            }
        },
        buildTicks: function() {
            var me = this;
    ...
    function getTickBackdropHeight(opts) {
        var tickOpts = opts.ticks;
        if (tickOpts.display && opts.display) return valueOrDefault$c(tickOpts.fontSize, core_defaults.global.defaultFontSize) + tickOpts.backdropPaddingY * 2;
        return 0;
    }
 ...
 */ function fitWithPointLabels(scale) {
    ...
    function adjustPointPositionForLabelHeight(angle, textSize, position) {
        if (angle === 90 || angle === 270) position.y -= textSize.h / 2;
    ...
    function drawRadiusLine(scale, gridLineOpts, radius, index) {
        ...
        ctx.beginPath();
        if (circular) // Draw circular arcs between the points
	 ...
	 */ _drawLabels: function() {
            ...
            helpers$1.each(me.ticks, function(label, index) {
                if (index === 0 && !tickOpts.reverse) return;
                offset = me.getDistanceFromCenterForValue(me.ticksAsNumbers[index]);
 ...
 */ function buildLookupTable(timestamps, min, max, distribution) {
        ...
        for(i = 0, ilen = items.length; i < ilen; ++i){
            ...
            if (prev === undefined || next === undefined || Math.round((next + prev) / 2) !== curr) table.push({
                time: curr,
                pos: i / (ilen - 1)
            });
        }
    ...
    function lookup(table, key, value) {
        ...
        while(lo >= 0 && lo <= hi){
            ...
            i0 = table[mid - 1] || null;
            i1 = table[mid];
            if (!i0) // given value is outside table (before first item)
            return {
                lo: null,
                hi: i1
            };
            else if (i1[key] < value) lo = mid + 1;
            else if (i0[key] > value) hi = mid - 1;
            else return {
                lo: i0,
                hi: i1
            };
 ...
 */ function generate(scale, min, max, capacity) {
        ...
        if (adapter.diff(max, min, minor) > 100000 * stepSize) throw min + " and " + max + " are too far apart with stepSize of " + stepSize + " " + minor;
 ...
 */ function computeOffsets(table, ticks, min, max, options) {
        ...
        if (options.offset && ticks.length) {
            ...
            if (ticks.length === 1) start = 1 - first;
            else start = (interpolate$1(table, "time", ticks[1], "pos") - first) / 2;
            last = interpolate$1(table, "time", ticks[ticks.length - 1], "pos");
            if (ticks.length === 1) end = last;
            else end = (last - interpolate$1(table, "time", ticks[ticks.length - 2], "pos")) / 2;
        }
        return {
            start: start,
            end: end,
	 ...
	 */ getRightValue: function(rawValue) {
            if (rawValue && rawValue.t !== undefined) rawValue = rawValue.t;
        ...
        buildTicks: function() {
            ...
            if (source === "data" || source === "auto" && distribution === "series") timestamps = timestamps.data;
            else if (source === "labels") timestamps = timestamps.labels;
            else timestamps = generate(me, min, max, capacity);
	 ...
	 */ getLabelCapacity: function(exampleTime) {
            ...
            var exampleLabel = me.tickFormatFunction(exampleTime, 0, ticksFromTimestamps(me, [
                exampleTime
    ...
    core_adapters._date.override(typeof moment === "function" ? {
        ...
        parse: function(value, format) {
            if (typeof value === "string" && typeof format === "string") value = moment(value, format);
            else if (!(value instanceof moment)) value = moment(value);
        ...
        startOf: function(time, unit, weekday) {
            time = moment(time);
            if (unit === "isoWeek") return time.isoWeekday(weekday).valueOf();
    ...
    function computeLinearBoundary(source) {
        ...
        if (fill === "start") target = model.scaleBottom === undefined ? scale.bottom : model.scaleBottom;
        else if (fill === "end") target = model.scaleTop === undefined ? scale.top : model.scaleTop;
        else if (model.scaleZero !== undefined) target = model.scaleZero;
 ...
 */ var Legend = core_element.extend({
        ...
        buildLabels: function() {
            ...
            var legendItems = helpers$1.callback(labelOpts.generateLabels, [
                me.chart
            ], me) || [];
        ...
        draw: function() {
            ...
            var drawLegendBox = function(x, y, legendItem) {
                ...
                if (labelOpts && labelOpts.usePointStyle) {
                    ...
                    if (lineWidth !== 0) ctx.strokeRect(rtlHelper.leftForLtr(x, boxWidth), y, boxWidth, fontSize);
                }
                ctx.restore();
            };
            ...
            helpers$1.each(me.legendItems, function(legendItem, i) {
                ...
                if (isHorizontal) cursor.x += width + labelOpts.padding;
                else cursor.y += itemHeight;
            });
	 ...
	 */ _getLegendItemAt: function(x, y) {
            ...
            if (x >= me.left && x <= me.right && y >= me.top && y <= me.bottom) {
                ...
                for(i = 0; i < lh.length; ++i){
                    hitBox = lh[i];
                    if (x >= hitBox.left && x <= hitBox.left + hitBox.width && y >= hitBox.top && y <= hitBox.top + hitBox.height) // Touching an element
	 ...
	 */ handleEvent: function(e) {
            ...
            if (type === "click") {
                if (hoveredItem && opts.onClick) // use e.native for backwards compatibility
                ...
                if (opts.onHover && hoveredItem) // use e.native for backwards compatibility
...
},{"dcf84c2b8d413eca":"jmLGx"}],"jmLGx":[function(require,module,exports) {
//! moment.js
//! version : 2.30.1
...
},{}],"h9wbC":[function(require,module,exports) {
/*!
 ...
 * Released under the MIT license
 */ (function(global, factory) {
    module.exports = factory(require("1b67f8f9eff80003"));
})(this, function(Chart) {
    "use strict";
    ...
    var utils = {
        ...
        toTextLines: function(inputs) {
            ...
            while(inputs.length){
                ...
                else if (!helpers.isNullOrUndef(inputs)) lines.unshift("" + input);
            }
            return lines;
        },
        ...
        toFontString: function(font) {
            if (!font || helpers.isNullOrUndef(font.size) || helpers.isNullOrUndef(font.family)) return null;
            return (font.style ? font.style + " " : "") + (font.weight ? font.weight + " " : "") + font.size + "px " + font.family;
        },
    ...
    function getPositioner(el) {
        if (el instanceof Chart.elements.Arc) return positioners.arc;
	 ...
	 */ _modelize: function(display, lines, config, context) {
            ...
            var index = me._index;
            var resolve = helpers$1.options.resolve;
            var font = utils.parseFont(resolve([
                config.font,
                {}
            ], context, index));
            var color = resolve([
            ...
            return {
                ...
                padding: helpers$1.options.toPadding(resolve([
                    config.padding,
                    0
                ], context, index)),
        ...
        update: function(context) {
            ...
            if (display) {
                ...
                label = helpers$1.valueOrDefault(helpers$1.callback(config.formatter, [
                    value,
                    context
                ]), value);
    ...
    var formatter = function(value) {
        if (helpers$3.isNullOrUndef(value)) return null;
        var label = value;
        var keys, klen, k;
        if (helpers$3.isObject(value)) {
            if (!helpers$3.isNullOrUndef(value.label)) label = value.label;
            else if (!helpers$3.isNullOrUndef(value.r)) label = value.r;
            else {
                label = "";
 ...
 */ var helpers$4 = Chart.helpers;
    ...
    function configure(dataset, options) {
        ...
        if (keys.length) keys.forEach(function(key) {
            if (labels[key]) configs.push(helpers$4.merge({}, [
                options,
                labels[key],
                {
                    _key: key
    ...
    function dispatchEvent(chart, listeners, label) {
        ...
        if (!callback) return;
        if (helpers$4.callback(callback, [
            context
        ]) === true) {
    ...
    function invalidate(chart) {
        ...
        for(var i = 0, ilen = animations.length; i < ilen; ++i){
            if (animations[i].chart === chart) return;
        }
    ...
    var plugin = {
        ...
        afterDatasetUpdate: function(chart, args, options) {
            ...
            for(i = 0, ilen = elements.length; i < ilen; ++i){
                el = elements[i];
                el[EXPANDO_KEY] = [];
                if (visible && el && !el.hidden && !el._model.skip) for(j = 0, jlen = config.labels.length; j < jlen; ++j){
                    cfg = config.labels[j];
                    key = cfg._key;
        ...
        beforeEvent: function(chart, event) {
            ...
            if (chart[EXPANDO_KEY]._listened) switch(event.type){
                case "mousemove":
                case "mouseout":
...
},{"1b67f8f9eff80003":"9ealU"}],"9TUBE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./types/options":"h6Lbv","./l10n/default":"2ezWJ","./utils":"60dOz","./utils/dom":"dDPhm","./utils/dates":"9Bvxm","./utils/formatting":"165vV","./utils/polyfills":"bMZt9","@parcel/transformer-js/src/esmodule-helpers.js":"fzHz3"}],"h6Lbv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fzHz3"}],"fzHz3":[function(require,module,exports) {
...
},{}],"2ezWJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fzHz3"}],"60dOz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fzHz3"}],"dDPhm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fzHz3"}],"9Bvxm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./formatting":"165vV","../types/options":"h6Lbv","../l10n/default":"2ezWJ","@parcel/transformer-js/src/esmodule-helpers.js":"fzHz3"}],"165vV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utils":"60dOz","@parcel/transformer-js/src/esmodule-helpers.js":"fzHz3"}],"bMZt9":[function(require,module,exports) {
"use strict";
...
},{}],"4m4gE":[function() {},{}],"hIdEt":[function() {},{}]},["2RLOf","agUpL"], "agUpL", "parcelRequire9829")
